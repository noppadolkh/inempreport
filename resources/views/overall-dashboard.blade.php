...
<button class="btn btn-info" type="button" style="float: right;" onclick="window.location.href='{{url('allarrivechart')}}'">ดูการแสดงผลในรูปแบบกราฟรายเดือน</button>
<div class="col-md-12" style="margin-top:50px;">
    ...
    <script>
        function filterselect(){
            ...
            window.location.href= '{{url("arriving/overall?month=")}}'+month+'&year='+year+'&user_id='+user_id;
        }
    </script>
</div>
...
<script type="text/javascript">
  ...
  $(function () {
    ...
    var table = $('.yajra-datatable').DataTable({
        ...
        order: [[ 0, "desc" ]],
        //ajax: "{{ route('allarrive.list') }}",

        ajax: {
            url: "{{ route('allarrive.list') }}",
            type: 'GET',
            data: function (d) {
